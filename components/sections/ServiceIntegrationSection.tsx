...
const serviceComponents = [
  ...
  },
  {
    ...
    tiers: ["Standard setup", "Done-for-you configuration", "Custom integrations"],
  },
  {
    icon: Users,
    title: "Team Enablement",
    description: "Role-based training and coaching to build internal capabilities and drive adoption",
    tiers: ["Foundation training", "90-day coaching", "Extended implementation support"],
  },
  {
    icon: TrendingUp,
