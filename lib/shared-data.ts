...
export const ROLE_BASED_CONTENT: RoleData[] = [
  ...
  },
  {
    ...
    aspirations: [
      "Integrate securely without complex configuration or custom code?",
      "Eliminate server maintenance, patching, and upgrade headaches?",
      "Reduce shadow IT by giving ops a tool that actually works?",
    ],
    benefits: [
      "Secure, API-ready integrations—no custom coding required",
      "Cloud-native infrastructure—no servers, no patches, no hassle",
      "Operational transparency that keeps ops self-sufficient (and off your ticket queue)",
    ],
